...
function FactorForm({ setShowEditFactorsModal }) {
  ...
  const [familyFriendValue, setFamilyFriendValue] = useState(factors.familyFriend);
  ...
  const [complicatedClientValue, setComplicatedClientValue] = useState(factors.complicatedClient);
